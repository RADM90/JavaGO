...
%>
<title>gallery/writeForm.jsp</title>
</head>
<body onload="document.fr.subject.focus()">
<jsp:include page="../inc/top.jsp"></jsp:include>
<fieldset>
	<legend><%=boardName.toUpperCase() %></legend>
	<form action="writePro.jsp?boardName=<%=boardName%>" method="post" enctype="multipart/form-data" name="fr">
	...
	<table border="1" id="table02">
		...
		<tr>
			<th>파일</th><td id="data"><input type="file" name="file" required></td>
		</tr>
		<tr>
