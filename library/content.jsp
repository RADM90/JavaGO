...
<head>
<meta charset="UTF-8">
<title>library/content.jsp</title>
<%
...
<fieldset>
	...
	<table border="1" id="table02">
		...
		<tr>
			<th>글내용</th><td id="content" colspan="7"><%=content %></td>
		</tr>
		<tr>
			<th colspan="8" style="text-align: center">
<%-- 				<input type="button" value="글수정" onclick="location.href='updateForm.jsp?boardName=<%=bb.getBoardName() %>&num=<%=bb.getIdx()%>'"> --%>
