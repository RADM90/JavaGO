...
<tr><th width="60px">글번호</th><th>제목</th><th width="140px">작성자</th><th width="100px">날짜</th><th width="60px">조회수</th><th width="40px">첨부</th></tr>
<%
...
<tr>
	...
	<td id="data"><%if (bb.getFile()==null) {out.print("");} else {%><a href="file_down.jsp?file_name=<%=bb.getFile() %>"><img src="attachmentIcon.png" alt="첨부파일" width="10px" height="10px"></a><%}%></td>
</tr>
...
<% if (id != null) {
	...
	%>
	<form action="listSearch.jsp?boardName=<%=boardName %>&pageNum=1" method="post">
	<select name="option"><option value="subject" selected>제목</option><option value="content">내용</option><option value="name">작성자</option></select>
	<input type="text" name="search"> <input type="image" src="search.png" width="15px" height="15px"></form>
</fieldset>
